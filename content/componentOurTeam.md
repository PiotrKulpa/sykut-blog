...
content: >-
  ...
  \    <h2><span class="theme_color">We Have a Professional</span> Team of
  Business Analysts.</h2>
  ...
  \    <li data-target="#team_slider" data-slide-to="0" class=""></li>


  \    <li data-target="#team_slider" data-slide-to="1" class="active"></li>
